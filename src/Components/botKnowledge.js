const botKnowledge = [
  {
    ...
    answer: `Hello 👋, welcome to ${process.env.NEXT_PUBLIC_APP_NAME} FINANCE! I’m your assistant. You can ask me anything about deposits, withdrawals, loans, investment plans, or even trading. How can I make your day easier today?`
  },
  {
    keywords: [
      'deposit',
  ...
  },
  {
    ...
    answer: `Goodbye 👋, and thanks for chatting with ${process.env.NEXT_PUBLIC_APP_NAME} FINANCE! Wishing you profitable investments ahead. Come back anytime you need me.`
  }
]
